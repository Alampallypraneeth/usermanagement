    ...
    <div className="space-y-10">
      ...
      <div className="glass-panel p-8 md:p-12 rounded-3xl relative overflow-hidden flex flex-col md:flex-row justify-between items-center gap-6 shadow-[0_20px_50px_rgba(99,102,241,0.1)]">
        <div className="space-y-4 max-w-2xl text-center md:text-left z-10">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-805 border border-slate-700 text-xs font-semibold text-slate-300">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-2">
            <Link
              to="/users"
              className="flex items-center gap-2 bg-white hover:bg-slate-100 text-slate-950 font-bold py-3 px-6 rounded-2xl shadow-sm transition-all duration-200 hover:scale-[1.03] text-sm"
            >
            ...
            <Link
              to="/add-user"
              className="flex items-center gap-2 bg-slate-900 hover:bg-slate-805 border border-slate-700/80 text-slate-200 font-bold py-3 px-6 rounded-2xl transition-all duration-200 hover:scale-[1.03] text-sm"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="glass-panel glass-panel-hover p-6 rounded-2xl flex items-center gap-5">
          <div className="p-4 bg-slate-805 border border-slate-700 rounded-2xl text-slate-300 shadow-sm">
        ...
        {/* Metric 2 */}
        <div className="glass-panel glass-panel-hover p-6 rounded-2xl flex items-center gap-5">
          <div className="p-4 bg-emerald-950/20 border border-emerald-800/40 rounded-2xl text-emerald-400">
        ...
        {/* Metric 3 */}
        <div className="glass-panel glass-panel-hover p-6 rounded-2xl flex items-center gap-5">
          <div className="p-4 bg-rose-950/20 border border-rose-800/40 rounded-2xl text-rose-400">
        ...
        {/* Metric 4 */}
        <div className="glass-panel glass-panel-hover p-6 rounded-2xl flex items-center gap-5">
          <div className="p-4 bg-slate-805 border border-slate-700 rounded-2xl text-slate-350 shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 glass-panel p-6 md:p-8 rounded-3xl space-y-6">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-slate-805 border border-slate-700 rounded-xl text-slate-300">
            ...
            <Link to="/users" className="text-slate-300 hover:text-white text-xs font-bold flex items-center gap-1 group">
              <span>View All</span>
                    ...
                    return (
                      <tr key={user._id} className="hover:bg-white/5 transition-all duration-150">
                        <td className="py-4 pl-2">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-xl bg-slate-805 border border-slate-700 text-slate-200 font-extrabold flex justify-center items-center shadow-md text-sm">
                              {initials}
                            </div>
                            <div>
                        ...
                        <td className="py-4">
                          <div className="space-y-1 text-xs font-semibold text-slate-400">
                            <p className="flex items-center gap-1.5"><Mail className="w-3.5 h-3.5 text-slate-400" /> {user.email}</p>
                            <p className="flex items-center gap-1.5"><Phone className="w-3.5 h-3.5 text-slate-400" /> {user.mobileNumber}</p>
                          </div>
                        </td>
                        <td className="py-4">
        ...
        <div className="glass-panel p-6 md:p-8 rounded-3xl flex flex-col justify-between gap-6">
          <div className="space-y-5">
            <div className="p-2.5 bg-slate-805 border border-slate-700 rounded-2xl w-fit text-slate-300">
            ...
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-slate-805 border border-slate-700 text-slate-300 flex justify-center items-center font-bold">
                    +
                  </div>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-slate-805 border border-slate-700 text-slate-300 flex justify-center items-center">
